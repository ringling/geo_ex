defmodule EllipsoidalCalculations do
  ...
  defp calc(a, b, _f, _l, _lambda, _lambdaP, _cosU1, _cosU2, _sinU1, _sinU2, sigma, sinSigma, cosSqAlpha, cosSigma, cos2SigmaM, iterLimit) do
    result(cosSqAlpha, a, b, sigma, sinSigma, cos2SigmaM, cosSigma, sinSigma, iterLimit)
  end

  defp result(_cosSqAlpha, _a, _b, _sigma, _sinSigma, _cos2SigmaM, _cosSigma, _sinSigma, 0) do
    "Nan"
  end

  defp result(cosSqAlpha,a,b, sigma, sinSigma, cos2SigmaM, cosSigma, sinSigma, _iterLimit) do
